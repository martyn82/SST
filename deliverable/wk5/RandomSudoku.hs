...
main show rs = do let usediff = False -- turn off the difficulty function
                  [r] <- rsolveNs rs [emptyN rs]
                  showNode show r
                  s <- genProblem rs r
                  showNode show s
...
randomNode rs = do let usediff = False -- turn off the difficulty function
                   [r] <- rsolveNs rs [emptyN rs]
                   s <- genProblem rs r
                   return s